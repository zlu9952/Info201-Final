...
overview_tab <- tabPanel("Introduction",
                ...
                h3("Major Questions:"),
                p("What influence does climate change exert on honey production?"),
                p("How do fluctuations in average temperatures and bee colony numbers correlate with variations in honey production and pricing?"),
                h3("Data Sources:"),
                p("1. https://www.kaggle.com/datasets/jessicali9530/honey-production"),
                p("2. https://www.kaggle.com/datasets/berkeleyearth/climate-change-earth-surface-temperature-data?select=GlobalLandTemperaturesByCountry.csv"),
                p("The first dataset provides information on honey production from 1998 to 2012. The second dataset provides global climate change in average temperature from 1743 to 2013. For comparison, we have combined the two datasets and matched dates for better visualization"),
                h3("Ethical Considerations and Limitations"),
                p("While conducting our analysis, we remain mindful of potential ethical questions associated with data usage. The limitations of the dataset may include incomplete or unavailable information for certain states. We encourage a thoughtful consideration of these aspects in the interpretation of our findings."),
